...
category_university = {
	...
	'info': 
		[
			...
			'sj19_chong_lost','sj20_sejong_dc','sj21_sejong_wiki','sj24_sejong_allie','sj29_sejong_dormitory'
			...
			'sj44_naverblog_sejong','sj44_naverblog_campustown','sig47_20lab_column',
			'sig47_20lab_announcement','sig47_20lab_announcement','sig47_20lab_data','sig47_20lab_report',
			'sig51_univ20_main','sig52_youthcenter_info','sig53_kosaf_info','sig54_naver_news'
		],
	'tag': 
		[
			'장학','사이버강의','수강','졸업','조교','faq','소식','학사','국제',
			'교환학생','수강편람','입학','학술정보원','입찰','방송국','홍보원','교내',
			'전화번호부','총학생회','기숙사','전자도서관','학사일정',
			'칼리지','에델바이스','학부','kmooc','블랙보드','uis','학기','창의','학술',
			'세종대학교','세종대','세종인','휴학','학교','연구','전공','사업단',
			'홍보원','장학금','기숙사','도서관','캠퍼스타운','학위','캠퍼스','대학내일','20대','연구소',
			'청년','뉴스','skbs'
		],
	'info_num': [],
	'topic_vector': []
...
category_club = {
	...
	'tag': 
		[
			'멘토링','학생회','동아리','모임','스터디','서포터즈','봉사단',
			'동호회','봉사','아카데미','학생회','멘토','멘티','소모임','공부','교육'
		],
	'info_num': [],
	'topic_vector': []
}
...
category_except = {
	...
	'info':
		[
			...
			'sj16_navercafe_eleinfoengineer','sj16_navercafe_imc','sj16_navercafe_club','sj9_computer_notice','sig46_addcampus_board'
		],
	'tag': [],
	'info_num': [],
}
